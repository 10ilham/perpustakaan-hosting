        ...
        <div class="info-data">
            ...
            <div class="card">
                ...
                <div class="detail-link-container">
                    <a href="{{ route('buku.index') }}" class="label detail-link">Lihat Detail</a>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="detail-link-container">
                    <a href="{{ route('peminjaman.index') }}" class="label detail-link">Lihat Detail</a>
                </div>
            </div>
                            ...
                            @if (isset($bukuPopuler) && count($bukuPopuler) > 0)
                                @foreach ($bukuPopuler as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('buku.detail', ['id' => $item->buku->id, 'dashboard' => 'admin']) }}"
                                                {{-- 'admin' penamaan url bebas karena hanya sebagai referensi --}} class="btn btn-sm btn-info">
...
@section('scripts')
    <script>
        ...
        function loadChart(period) {
            ...
            fetch(`{{ url('/admin/chart-data') }}?period=${period}`)
